Shader "Hidden/Locked/.poiyomi/Poiyomi 8.0/Poiyomi Outline/af827d3ebf25dec42b51d7ace10ab911"
{
 ...
 #define _LIGHTINGMODE_FLAT 
			...
			void applyOutlineColor(inout PoiFragData poiFragData, in PoiMesh poiMesh, in PoiLight poiLight, in PoiMods poiMods)
			{
				...
				float4 col = POI2D_SAMPLER_PAN(_OutlineTexture, _MainTex, poiUV(poiMesh.uv[float(0)], float4(1,1,0,0)), float4(0,0,0,0)) * float4(poiThemeColor(poiMods, float4(0.764151,0.6019491,0.6195797,1).rgb, float(0)), float4(0.764151,0.6019491,0.6195797,1).a);
