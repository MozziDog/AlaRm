Shader "Hidden/Locked/.poiyomi/Poiyomi 8.0/Poiyomi Outline/d5dcd7e72061a1c41a46e007fdfa44e3"
{
 ...
 #define _LIGHTINGMODE_FLAT 
			...
			void applyOutlineColor(inout PoiFragData poiFragData, in PoiMesh poiMesh, in PoiLight poiLight, in PoiMods poiMods)
			{
				...
				float4 col = POI2D_SAMPLER_PAN(_OutlineTexture, _MainTex, poiUV(poiMesh.uv[float(0)], float4(1,1,0,0)), float4(0,0,0,0)) * float4(poiThemeColor(poiMods, float4(0.6226415,0.5438473,0.508099,1).rgb, float(0)), float4(0.6226415,0.5438473,0.508099,1).a);
